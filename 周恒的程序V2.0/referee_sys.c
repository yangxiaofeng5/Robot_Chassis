...
uint8_t seq=0;//包序号
void Send_Date_To_Referee(float dete1,float dete2,float dete3,char dete4,char id)//float date1,float date2,float date3,char dete4)//refDataStruct refData)
{
